            ...
            <div className='flex-1 flex flex-col min-w-0 overflow-hidden'>
                <header className='flex items-center justify-between px-6 py-3.5 bg-white/80 backdrop-blur-md border-b border-violet-100/60 shadow-sm flex-shrink-0'>
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <div className='w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-bold' style={{background:'linear-gradient(135deg,#7C3AED,#D97706)'}}>{ini(user.name || user.nom)}</div>
                    </div>
                </header>
