                    ...
                    <div className='card space-y-4'>
                        ...
                        <div>
                            ...
                            <div className='grid grid-cols-4 gap-2'>
                                {bloodTypes.map(b=>(
                            <button type='button' key={b} onClick={()=>setUser({...user,blood_type:b})} className={'py-2 rounded-xl text-sm font-bold border-2 transition-all '+(user.blood_type===b?'border-pink-500 bg-violet-50 text-pink-700':'border-gray-100 text-gray-500 hover:border-violet-200')}>{b}</button>
                        ))}
                    </div>
                </div>
