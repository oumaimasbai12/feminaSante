    ...
    return (
        <AuthLayout title='Bon retour 👋' subtitle='Connectez-vous pour continuer votre parcours santé'>
            ...
            <form onSubmit={submit} className='space-y-5'>
                ...
                <div className='flex items-center justify-between'>
                    <label className='flex items-center gap-2 text-sm text-gray-600 cursor-pointer'>
                        <input type='checkbox' className='rounded border-pink-300 text-pink-600 focus:ring-pink-300' />
                        Se souvenir de moi
                    </label>
                    <Link href='/forgot-password' className='text-sm font-semibold text-pink-700 hover:text-pink-800 transition-colors'>Mot de passe oublié ?</Link>
                </div>
            ...
            <p className='mt-8 text-center text-sm text-gray-500'>
                ...
                <Link href='/register' className='font-semibold text-pink-700 hover:text-pink-800 transition-colors'>Créer un compte gratuit</Link>
            </p>
        </AuthLayout>
    );
}