...
export default function QuizExplanations() {
    return (
        <div className="space-y-6 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-brand-ink mb-6">Explications détaillées</h2>

            <div className="glass-card border-2 border-green-200">
                <p className="font-bold text-brand-ink mb-2">1. Est-il vrai que la pilule contraceptive rend stérile à long terme ?</p>
                <div className="flex items-center gap-2 mb-4">
                    <span className="bg-green-100 text-green-800 font-bold px-3 py-1 rounded">Faux</span>
                    <span className="text-sm text-brand-muted font-medium">Votre réponse : Faux (Correct)</span>
                </div>
            ...
            <div className="glass-card border-2 border-red-200">
                <p className="font-bold text-brand-ink mb-2">2. Les règles douloureuses (dysménorrhée) sont toujours normales.</p>
                <div className="flex items-center gap-2 mb-4">
                    <span className="bg-green-100 text-green-800 font-bold px-3 py-1 rounded">Faux</span>
                    <span className="text-sm text-brand-muted font-medium">Votre réponse : Vrai (Incorrect)</span>
                </div>
                <p className="text-brand-muted leading-relaxed">
